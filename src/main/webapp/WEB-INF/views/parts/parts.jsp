...
<div class="container-fluid">
    <h1 class="mt-4 mb-3 text-light">Venda de Peças</h1>
    ...
    <table class="table text-light">
        ...
        <tbody>
            <c:forEach var="part" items="${parts}"></c:forEach>
            <!-- Exemplo de linha da tabela -->
            <tr>
                
                <td>Peça A<c:out value="${part.description}" /></td>
                <td>R$ 50,00<c:out value="${part.value}" /></td>
                <td>10<c:out value="${part.quantity}" /></td>
                <td>
                    <!-- Botões de ação -->
                    
                    <button data-toggle="modal" data-target="#novaPecaModal" class="btn btn-primary btn-sm mr-2">Comprar</button>
                </td>
            </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="text-dark">
                    ...
                    <a type="submit" class="btn btn-success" href="<%=request.getContextPath()%>/signin">Comprar</a>
