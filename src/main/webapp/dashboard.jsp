...
<body>
        ...
        <section id="form" class="py-5">
            <div class="container text-center">
                <h1 class="display-4 font-weight-normal text-white mb-4">Como podemos te ajudar hoje?</h1>
                <a href="${pageContext.request.contextPath}/SaleServlet" class="btn btn-outline-light btn-lg font-weight-bold mr-3">Comprar peças</a>
                <a href="${pageContext.request.contextPath}/ServiceOrderServlet" class="btn btn-outline-warning btn-lg ">Contratar serviços</a>
            </div>
        </section>
